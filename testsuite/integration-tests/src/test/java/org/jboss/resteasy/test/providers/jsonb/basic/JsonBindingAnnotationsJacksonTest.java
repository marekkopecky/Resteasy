...
public class JsonBindingAnnotationsJacksonTest {
   ...
   public void negativeScenarioOnServer() throws Exception {
      ...
      try {
         ...
         Assert.assertThat("Wrong response code", responseCode, is(500));
         String responseBody = response.readEntity(String.class);
         Assert.assertThat("Wrong response error message", responseBody, not(containsString("java.lang.ExceptionInInitializerError")));
      } finally {
         client.close();
      }
   }
