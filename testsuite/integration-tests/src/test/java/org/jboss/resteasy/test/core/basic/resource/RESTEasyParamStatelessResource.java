...
//@RequestScoped
public class RESTEasyParamStatelessResource
{
   private static Logger logger = Logger.getLogger(RESTEasyParamStatelessResource.class);
   ...
   public RESTEasyParamStatelessResource(
